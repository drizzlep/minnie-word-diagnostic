...
const practice = [
  ...
  q("practice-audio", "audio", "teacher", "teacher", ["teacher", "picture", "student", "weather"], { practice: true }),
...
const aDay1 = [
  ...
  q("a1-m-children", "meaning", "children", "孩子们", ["孩子们", "父母", "同学们", "朋友们"], { pattern: "word-form", lemma: "child" }),
  q("a1-s-colourful", "spelling", "colourful", "colourful", [], { prompt: "多彩的", pattern: "irregular" }),
  q("a1-a-direction", "audio", "direction", "direction", ["direction", "different", "delicious", "difficult"]),
...
const aDay2 = [
  ...
  q("a2-s-dangerous", "spelling", "dangerous", "dangerous", [], { prompt: "危险的", pattern: "irregular" }),
  ...
  q("a2-a-delicious", "audio", "delicious", "delicious", ["delicious", "different", "direction", "difficult"], { pattern: "irregular" }),
...
const bDay1 = [
  ...
  q("b1-m-parents", "meaning", "parents", "父母", ["父母", "祖父母", "孩子", "朋友"], { pattern: "word-form", lemma: "parent" }),
  q("b1-s-saturday", "spelling", "Saturday", "saturday", [], { prompt: "星期六" }),
  q("b1-a-medicine", "audio", "medicine", "medicine", ["medicine", "musician", "machine", "cinema"], { pattern: "irregular" }),
  ...
  q("b1-a-classmate", "audio", "classmate", "classmate", ["classmate", "classroom", "classical", "classwork"], { pattern: "compound" }),
  q("b1-s-exercises", "spelling", "exercise", "exercises", [], { prompt: "练习（复数）", pattern: "word-form", wordForm: "plural" }),
  q("b1-m-important", "meaning", "important", "重要的", ["重要的", "危险的", "不同的", "有趣的"]),
  q("b1-s-celebration", "spelling", "celebration", "celebration", [], { prompt: "庆祝；庆典", pattern: "irregular" }),
];
...
const bDay2 = [
  ...
  q("b2-f-brought", "wordForm", "bring", "brought", [], { prompt: "bring 的过去式", pattern: "word-form", wordForm: "past" }),
  q("b2-a-restaurant", "audio", "restaurant", "restaurant", ["restaurant", "supermarket", "direction", "interesting"], { pattern: "irregular" }),
  q("b2-s-grandmother", "spelling", "grandmother", "grandmother", [], { prompt: "祖母", pattern: "compound" }),
  q("b2-s-comfortable", "spelling", "comfortable", "comfortable", [], { prompt: "舒适的", pattern: "irregular" }),
];
...
function q(id, type, word, answer, choices = [], extra = {}) {
  ...
  const lemma = String(extra.lemma ?? word).toLowerCase();
  const curriculum = extra.practice ? null : curriculumFor(lemma);
  if (!extra.practice && !curriculum) throw new Error(`缺少教材映射: ${lemma}`);
  return {
    id,
    type,
    ...
    core: !extra.practice,
    source: extra.practice ? "不计分操作练习" : SOURCE_LABEL,
    curriculum,
